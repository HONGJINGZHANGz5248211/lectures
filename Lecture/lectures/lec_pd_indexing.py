...
x  = ser.loc[['2020-01-03', '2020-01-10']]   #list double [] and , inside: [[,]]
print(x)
...
x = ser.loc['2020-01-03':'2020-01-10']  #end point is included
print(x)
...
# 1.2.1 Dataframe.loc: Selection using a single label: df.loc['202001-03','Close']
...
x = df.loc['2020-01-06':, :]  #from 1/6 to the end of the row
print(x)
...
df2.rename(index={'2020-01-08':'1900-01-01'}, inplace=True)  #change the original copy use inplace=True
print(df2)
print()
...
# This will return a series with the first element only   #endpoint doesn't include
x = ser[0:1]
print(x)
